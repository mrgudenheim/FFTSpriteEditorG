...
func write_shp() -> void:
	...
	var save_file := FileAccess.open("user://FFTSpriteEditorG/"+file_name+".shp", FileAccess.WRITE)
...
func set_data_from_cfg(filepath:String) -> void:
	...
	#var err = cfg.load("user://FFTSpriteEditorG/"+file_name+"_shp.cfg")
...
func write_cfg() -> void:
	...
	cfg.save("user://FFTSpriteEditorG/"+file_name+"_shp.cfg")
...
func write_csvs() -> void:
	...
	DirAccess.make_dir_recursive_absolute("user://FFTSpriteEditorG")
	var save_file = FileAccess.open("user://FFTSpriteEditorG/frame_data_"+file_name+".txt", FileAccess.WRITE)
	...
	if (file_name.begins_with("wep") || file_name.begins_with("eff")):		
		...
		var save_file_offset:FileAccess = FileAccess.open("user://FFTSpriteEditorG/frame_offset_data_"+file_name+".txt", FileAccess.WRITE)
