...
func write_seq() -> void:
	...
	var save_file := FileAccess.open("user://FFTSpriteEditorG/"+file_name+".seq", FileAccess.WRITE)
...
func write_wiki_table() -> void:
	...
	DirAccess.make_dir_recursive_absolute("user://FFTSpriteEditorG")
	var save_file = FileAccess.open("user://FFTSpriteEditorG/wiki_table_"+file_name+".txt", FileAccess.WRITE)
...
func write_cfg() -> void:
	...
	cfg.save("user://FFTSpriteEditorG/"+file_name+"_seq.cfg")
...
func write_csv() -> void:
	...
	DirAccess.make_dir_recursive_absolute("user://FFTSpriteEditorG")
	var save_file = FileAccess.open("user://FFTSpriteEditorG/animation_data_"+file_name+".txt", FileAccess.WRITE)
